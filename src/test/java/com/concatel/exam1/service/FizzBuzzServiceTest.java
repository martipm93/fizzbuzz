...
public class FizzBuzzServiceTest {
    ...
    @Autowired
    FizzBuzzService<FizzBuzzClient> fizzBuzzService;

    @DisplayName("Test the FizzBuzzService")
    @Test
    void testFindById() throws InterruptedException, ExecutionException {

        assertEquals(Arrays.asList(("4, buzz, fizz, 7, 8, fizz, buzz, 11, fizz, 13, 14, fizzbuzz, 16, 17, fizz, 19, " +
                ...
                "58, 59, fizzbuzz, 61, 62, fizz, 64, buzz, fizz, 67, 68, fizz, buzz, 71, fizz, 73, 74, fizzbuzz, 76, " +
                "77, fizz, 79, buzz, fizz, 82, 83, fizz, buzz, 86, fizz, 88, 89, fizzbuzz, 91, 92, fizz, 94, buzz, " +
                "fizz, 97, 98, fizz, buzz")
                .split(", ")), fizzBuzzService.findById(4).get().getFizzBuzzList());
    }
}
